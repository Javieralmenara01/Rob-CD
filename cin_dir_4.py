...
T04 = np.dot(T03, T34)
T44_1 = matriz_T(d[5], th[5], a[5], al[5])
T04_1 = np.dot(T04, T44_1)
T44_2 = matriz_T(d[6], th[6], a[6], al[6])
T04_2 = np.dot(T04, T44_2)
T55_1 = matriz_T(d[7], th[7], a[7], al[7])
T05_1 = np.dot(T04_1, T55_1)
T55_2 = matriz_T(d[8], th[8], a[8], al[8])
T05_2 = np.dot(T04_2, T55_2)
T66_1 = matriz_T(d[9], th[9], a[9], al[9])
T06_1 = np.dot(T05_1, T66_1)
T66_2 = matriz_T(d[10], th[10], a[10], al[10])
T06_2 = np.dot(T05_2, T66_2)
Tef = matriz_T(d[11], th[11], a[11], al[11])
TEF = np.dot(T04, Tef)
...
muestra_origenes([o00, o00_, o10, o20, o30, o40, [[o410, o510, o610], [o420, o520, o620]]], oEF0)
muestra_robot([o00, o00_, o10, o20, o30, o40, [[o410, o510, o610], [o420, o520, o620]]], oEF0)
