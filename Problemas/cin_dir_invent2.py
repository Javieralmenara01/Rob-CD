...
# Parámetros D-H:
#           1      2      A      3      4     41     42     51     52     61     62      EF
d  = [      5,     0,     0,     2,  p[3],     0,     0,     1,     1,  p[5],  p[5], 1+p[5]]  
th = [90+p[0],  p[1],    90,  p[2],     0,     0,     0,     0,     0,     0,     0,      0] 
a  = [      0,     2,     0,     0,     0,  p[4], -p[4],     0,     0,     0,     0,      0] 
al = [     90,     0,    90,     0,     0,     0,     0,     0,     0,     0,     0,      0] 
...
T02=np.dot(T01,T12)
T2A=matriz_T(d[2],th[2],a[2],al[2])
T0A=np.dot(T02,T2A)
TA3=matriz_T(d[3],th[3],a[3],al[3])
T03=np.dot(T0A, TA3)
...
T04EF=matriz_T(d[11],th[11],a[11],al[11])
T0EF=np.dot(T04, T04EF)
...
muestra_origenes([o00,o10,o20,o30,o40,[[o41, o51, o61],[o42, o52, o62]]], oef)
muestra_robot   ([o00,o10,o20,o30,o40,[[o41, o51, o61],[o42, o52, o62]]], oef)
