...
# Parámetros D-H:
#           1      2      3      4      5      6      61      62       EF
d  = [      5,     0,     0,     2,  p[3],     0,      0,      0,       0]
th = [   p[0],  p[1],    90,  p[2],     0,  p[4],90-p[5],90+p[5],      90]
a  = [      0,     2,     0,     0,     0,     0,      2,      2,       2]
al = [     90,     0,    90,     0,     0,    90,    180,    180,     180]
...
T6ef=matriz_T(d[8],th[8],a[8],al[8])
...
o601=np.dot(T061,o661).tolist()
o602=np.dot(T062,o662).tolist()
oEF =np.dot(T0ef,oEF).tolist()

# Mostrar resultado de la cinemática directa
muestra_origenes([o00,o10,o20,o30,o40,o50,o60,[[o601],[o602]]],oEF)
muestra_robot   ([o00,o10,o20,o30,o40,o50,o60,[[o601],[o602]]],oEF)
