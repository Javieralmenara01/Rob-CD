...
T01=np.dot(T0A,TA1)
T1B=matriz_T(d[2],th[2],a[2],al[2])
T0B=np.dot(T01, T1B)
TB2=matriz_T(d[3],th[3],a[3],al[3])
T02=np.dot(T0B, TB2)
...
muestra_origenes([o00,oa0,o10,ob0,o20,o30,[[o41],[o42]]],oef)
muestra_robot   ([o00,oa0,o10,ob0,o20,o30,[[o41],[o42]]],oef)
