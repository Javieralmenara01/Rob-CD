...
T02 = np.dot(T01, T12)
T22_ = matriz_T(d[2], th[2], a[2], al[2])
T02_ = np.dot(T02, T22_)
T2_3 = matriz_T(d[3], th[3], a[3], al[3])
T03 = np.dot(T02_, T2_3)
T34 = matriz_T(d[4], th[4], a[4], al[4])
T04 = np.dot(T03, T34)
T55_1 = matriz_T(d[5], th[5], a[5], al[5])
T05_1 = np.dot(T04, T55_1)
T55_2 = matriz_T(d[6], th[6], a[6], al[6])
T05_2 = np.dot(T04, T55_2)
