...
# Parámetros D-H:
#            1        2       3        4       5        61      62       71      72       EF 
d  = [      10,       0,      0,   -p[2],     -2,       0,       0,      -2,     -2,      -2]
th = [ 90+p[0],       0,   p[1],       0,   p[3],       0,       0,       0,      0,       0]
a  = [       0,       5,      5,       0,      0,       1,      -1,       0,      0,       0]
...
T561=matriz_T(d[5],th[5],a[5],al[5])
T061=np.dot(T05,T561)
T562=matriz_T(d[6],th[6],a[6],al[6])
T062=np.dot(T05,T562)

T6171=matriz_T(d[7],th[7],a[7],al[7])
T071=np.dot(T061,T6171)
T6272=matriz_T(d[8],th[8],a[8],al[8])
T072=np.dot(T062,T6272)

T5EF=matriz_T(d[9],th[9],a[9],al[9])
...
muestra_origenes([o00,o10,o20,o30,o40,o50,[[o61,o71],[o62,o72]]],oef)
muestra_robot   ([o00,o10,o20,o30,o40,o50,[[o61,o71],[o62,o72]]],oef)
