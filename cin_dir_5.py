...
T1_1 = matriz_T(d[2], th[2], a[2], al[2])
T11_ = np.dot(T01, T1_1)
...
T041 = np.dot(T03, T44_1)
T042 = np.dot(T03, T44_2)
Tef = matriz_T(d[7], th[7], a[7], al[7])
TEF = np.dot(T03, Tef)
...
muestra_origenes([o00, o00_, o10, o11_,  o20, o30, [[o410], [o420]]], oEF0)
muestra_robot([o00, o00_, o10, o11_, o20, o30, [[o410], [o420]]], oEF0)
